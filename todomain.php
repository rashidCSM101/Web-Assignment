...
<body>
  ...
  <h1 class="text-center main-heading">ToDo'S List </h1>
        ...
        <tbody>
          ...
          ?>
              <tr>
                ...
                <td style="text-align: end;width: 151px;">
                  <a class="btn btn-success btn-sm btn-2" href="edit.php?id=<?php echo $id ?>" role="button">Edit</a>
